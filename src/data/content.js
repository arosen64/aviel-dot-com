...
export const otherProjects = [
  ...
  },
  {
    ...
    description:
      "Inspired by a YouTube video on information theory, I set out to see whether an autoencoder could rediscover an optimal code on its own. I gave the network a bottleneck sized to the theoretical minimum number of bits needed to encode the input distribution optimally, drawn from a Super Mario 64 tool-assisted speedrun (TAS), and asked nothing of it but reconstruction. The question was whether it would find that fingerprint knowing nothing about information theory and optimizing nothing but reconstruction error. I trained on roughly 500,000 controller events, measured at 2.4683 bits each, and fixed the latent code at 247 bits, the floor for a 100-event window with no slack anywhere. The model reached an F1 of 0.977, which was promising but did not on its own prove what I had set out to show. To find out whether the encoder had really learned anything, I had to look inside the box at the latent dimension of the network itself. Through a series of quantitative experiments I concluded that it did encode something resembling an optimal bit code.",
